...
Each resource in your API (eg. Artists, Art) should be defined as its own CFC. *Collections and Members should be separate CFCs* (eg. @artistCollection.cfc@ and @artistMember.cfc@).
