...
** For the PUT and DELETE verbs, you may choose not to return any data -- in these cases, a status code is usually enough. For those cases, the "noData":http:// method is available.<br/><br/>
** With either *representationOf* or *noData*, you may optionally use the "withStatus":http:// method to set the http status code. If you do not include it, a default status of 200 will be returned.
